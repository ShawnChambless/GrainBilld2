...
angular.module('GrainBilld')
.controller('newBatchController', ["$scope", "newBatchService", "getGrain", "getHops", "getYeast", "$rootScope", function($scope, newBatchService, getGrain, getHops, getYeast, $rootScope) {
