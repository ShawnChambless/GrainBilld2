...
.controller('communityRecipesController', ["$scope", "communityRecipesService", "getCommunityRecipes", function($scope, communityRecipesService, getCommunityRecipes) {
...
angular.module('GrainBilld')
.controller('homeCtrl', ["$scope", "homeService", "getGrain", "getHops", "getYeast", "$cookies", "$rootScope", function($scope, homeService, getGrain, getHops, getYeast, $cookies, $rootScope) {
...
angular.module('GrainBilld')
.controller('newBatchController', ["$scope", "newBatchService", "getGrain", "getHops", "getYeast", "$rootScope", "$state", function($scope, newBatchService, getGrain, getHops, getYeast, $rootScope, $state) {
